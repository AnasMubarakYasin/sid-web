...
\f\r"'\`<>=]|("|')|))|$)`,"g"),I=/'/g,H=/"/g,B=/^(?:script|style|textarea|title)$/i,W=t=>(s,...i)=>({_$litType$:t,strings:s,values:i}),q=W(1),J=W(2),Z=W(3),F=Symbol.for("lit-noChange"),G=Symbol.for("lit-nothing"),K=new WeakMap,Q=E.createTreeWalker(E,129);function X(t,s){if(!O(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==T?T.createHTML(s):s}const Y=(t,s)=>{const i=t.length-1,e=[];let h,o=2===s?"<svg>":3===s?"<math>":"",r=V;for(let s=0;s<i;s++){const i=t[s];let n,c,a=-1,l=0;for(;l<i.length&&(r.lastIndex=l,c=r.exec(i),null!==c);)l=r.lastIndex,r===V?"!--"===c[1]?r=D:void 0!==c[1]?r=L:void 0!==c[2]?(B.test(c[2])&&(h=RegExp("</"+c[2],"g")),r=j):void 0!==c[3]&&(r=j):r===j?">"===c[0]?(r=h??V,a=-1):void 0===c[1]?a=-2:(a=r.lastIndex-c[2].length,n=c[1],r=void 0===c[3]?j:'"'===c[3]?H:I):r===H||r===I?r=j:r===D||r===L?r=V:(r=j,h=void 0);const u=r===j&&t[s+1].startsWith("/>")?" ":"";o+=r===V?i+A:a>=0?(e.push(n),i.slice(0,a)+M+i.slice(a)+x+u):i+x+(-2===a?s:u)}return[X(t,o+(t[i]||"<?>")+(2===s?"</svg>":3===s?"</math>":"")),e]};let tt=class tt{constructor({strings:t,_$litType$:s},i){let e;this.parts=[];let h=0,o=0;const r=t.length-1,n=this.parts,[c,a]=Y(t,s);if(this.el=tt.createElement(c,i),Q.currentNode=this.el.content,2===s||3===s){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(e=Q.nextNode())&&n.length<r;){if(1===e.nodeType){if(e.hasAttributes())for(const t of e.getAttributeNames())if(t.endsWith(M)){const s=a[o++],i=e.getAttribute(t).split(x),r=/([.?@])?(.*)/.exec(s);n.push({type:1,index:h,name:r[2],strings:i,ctor:"."===r[1]?ot:"?"===r[1]?rt:"@"===r[1]?nt:ht}),e.removeAttribute(t)}else t.startsWith(x)&&(n.push({type:6,index:h}),e.removeAttribute(t));if(B.test(e.tagName)){const t=e.textContent.split(x),s=t.length-1;if(s>0){e.textContent=C?C.emptyScript:"";for(let i=0;i<s;i++)e.append(t[i],U()),Q.nextNode(),n.push({type:2,index:++h});e.append(t[s],U())}}}else if(8===e.nodeType)if(e.data===k)n.push({type:2,index:h});else{let t=-1;for(;-1!==(t=e.data.indexOf(x,t+1));)n.push({type:7,index:h}),t+=x.length-1}h++}}static createElement(t,s){const i=E.createElement("template");return i.innerHTML=t,i}};function st(t,s,i=t,e){if(s===F)return s;let h=void 0!==e?i.N?.[e]:i.O;const o=N(s)?void 0:s._$litDirective$;return h?.constructor!==o&&(h?._$AO?.(!1),void 0===o?h=void 0:(h=new o(t),h._$AT(t,i,e)),void 0!==e?(i.N??=[])[e]=h:i.O=h),void 0!==h&&(s=st(t,h._$AS(t,s.values),h,e)),s}let it=class it{constructor(t,s){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}R(t){const{el:{content:s},parts:i}=this._$AD,e=(t?.creationScope??E).importNode(s,!0);Q.currentNode=e;let h=Q.nextNode(),o=0,r=0,n=i[0];for(;void 0!==n;){if(o===n.index){let s;2===n.type?s=new et(h,h.nextSibling,this,t):1===n.type?s=new n.ctor(h,n.name,n.strings,this,t):6===n.type&&(s=new ct(h,this,t)),this._$AV.push(s),n=i[++r]}o!==n?.index&&(h=Q.nextNode(),o++)}return Q.currentNode=E,e}V(t){let s=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,s),s+=i.strings.length-2):i._$AI(t[s])),s++}};let et=class et{get _$AU(){return this._$AM?._$AU??this.D}constructor(t,s,i,e){this.type=2,this._$AH=G,this._$AN=void 0,this._$AA=t,this._$AB=s,this._$AM=i,this.options=e,this.D=e?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const s=this._$AM;return void 0!==s&&11===t?.nodeType&&(t=s.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,s=this){t=st(this,t,s),N(t)?t===G||null==t||""===t?(this._$AH!==G&&this._$AR(),this._$AH=G):t!==this._$AH&&t!==F&&this.L(t):void 0!==t._$litType$?this.j(t):void 0!==t.nodeType?this.I(t):R(t)?this.H(t):this.L(t)}B(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}I(t){this._$AH!==t&&(this._$AR(),this._$AH=this.B(t))}L(t){this._$AH!==G&&N(this._$AH)?this._$AA.nextSibling.data=t:this.I(E.createTextNode(t)),this._$AH=t}j(t){const{values:s,_$litType$:i}=t,e="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=tt.createElement(X(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===e)this._$AH.V(s);else{const t=new it(e,this),i=t.R(this.options);t.V(s),this.I(i),this._$AH=t}}_$AC(t){let s=K.get(t.strings);return void 0===s&&K.set(t.strings,s=new tt(t)),s}H(t){O(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let i,e=0;for(const h of t)e===s.length?s.push(i=new et(this.B(U()),this.B(U()),this,this.options)):i=s[e],i._$AI(h),e++;e<s.length&&(this._$AR(i&&i._$AB.nextSibling,e),s.length=e)}_$AR(t=this._$AA.nextSibling,s){for(this._$AP?.(!1,!0,s);t!==this._$AB;){const s=t.nextSibling;t.remove(),t=s}}setConnected(t){void 0===this._$AM&&(this.D=t,this._$AP?.(t))}};let ht=class ht{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,s,i,e,h){this.type=1,this._$AH=G,this._$AN=void 0,this.element=t,this.name=s,this._$AM=e,this.options=h,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=G}_$AI(t,s=this,i,e){const h=this.strings;let o=!1;if(void 0===h)t=st(this,t,s,0),o=!N(t)||t!==this._$AH&&t!==F,o&&(this._$AH=t);else{const e=t;let r,n;for(t=h[0],r=0;r<h.length-1;r++)n=st(this,e[i+r],s,r),n===F&&(n=this._$AH[r]),o||=!N(n)||n!==this._$AH[r],n===G?t=G:t!==G&&(t+=(n??"")+h[r+1]),this._$AH[r]=n}o&&!e&&this.W(t)}W(t){t===G?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}};let ot=class ot extends ht{constructor(){super(...arguments),this.type=3}W(t){this.element[this.name]=t===G?void 0:t}};let rt=class rt extends ht{constructor(){super(...arguments),this.type=4}W(t){this.element.toggleAttribute(this.name,!!t&&t!==G)}};let nt=class nt extends ht{constructor(t,s,i,e,h){super(t,s,i,e,h),this.type=5}_$AI(t,s=this){if((t=st(this,t,s,0)??G)===F)return;const i=this._$AH,e=t===G&&i!==G||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,h=t!==G&&(i===G||e);e&&this.element.removeEventListener(this.name,this,i),h&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}};let ct=class ct{constructor(t,s,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=s,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){st(this,t)}};const at={q:M,J:x,Z:k,F:1,G:Y,K:it,X:R,Y:st,tt:et,st:ht,it:rt,et:nt,ht:ot,ot:ct},lt=P.litHtmlPolyfillSupport;lt?.(tt,et),(P.litHtmlVersions??=[]).push("3.3.1");const ut=(t,s,i)=>{const e=i?.renderBefore??s;let h=e._$litPart$;if(void 0===h){const t=i?.renderBefore??null;e._$litPart$=h=new et(s.insertBefore(U(),t),t,void 0,i??{})}return h._$AI(t),h},dt=globalThis;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
