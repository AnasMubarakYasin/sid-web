...
function debouncer(func: any, wait: number) {
...
const RichTextToolbar = () => {
  return (
    <div className="flex items-center p-1 gap-2 flex-wrap border">
      <RichTextUndo />
      <RichTextRedo />
      <RichTextSearchAndReplace />
      <RichTextClear />
    ...
    <>
      <div className="w-full">
        ...
        {typeof content === "string" && (
          <textarea
            className="w-full rounded-md border bg-background p-4 font-mono text-sm outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
            readOnly
            value={content}
          />
        )}
